...
export const axisConfigSchema: z.ZodObject<
  {
    ...
    format: z.ZodDefault<
      z.ZodEnum<["number", "percent", "compact", "currency"]>
    >;
...
// @public
export const barStyleSchema: z.ZodEnum<
  ["block", "shaded", "light", "hash", "equals", "arrow"]
>;
...
// @public
export class ChartComponent extends BaseTuiComponent<
  ChartInput,
  ...
  readonly schema: zod.ZodObject<
    {
        ...
        zod.ZodObject<
          {
            ...
            format: zod.ZodDefault<
              zod.ZodEnum<["number", "percent", "compact", "currency"]>
            >;
      ...
      yAxis: zod.ZodOptional<
        ...
        >
      >;
      legend: zod.ZodOptional<
        zod.ZodObject<
          {
            position: zod.ZodDefault<
              zod.ZodEnum<["none", "top", "bottom", "right", "inline"]>
            >;
      ...
      barStyle: zod.ZodDefault<
        zod.ZodEnum<["block", "shaded", "light", "hash", "equals", "arrow"]>
      >;
...
export const chartInputSchema: z.ZodObject<
  {
      ...
      z.ZodObject<
        {
          ...
          >;
          style: z.ZodOptional<
            z.ZodEnum<["block", "shaded", "light", "hash", "equals", "arrow"]>
          >;
        },
        "strip",
        z.ZodTypeAny,
    ...
    yAxis: z.ZodOptional<
      ...
      >
    >;
    legend: z.ZodOptional<
      z.ZodObject<
        {
          position: z.ZodDefault<
            z.ZodEnum<["none", "top", "bottom", "right", "inline"]>
          >;
...
// @public
export const chartTypeSchema: z.ZodEnum<
  [
    "bar",
    "bar-vertical",
    "bar-stacked",
...
// @public
export const legendPositionSchema: z.ZodEnum<
  ["none", "top", "bottom", "right", "inline"]
>;
...
// @public
export const scatterMarkerSchema: z.ZodEnum<
...
// @public
export const valueFormatSchema: z.ZodEnum<
  ["number", "percent", "compact", "currency"]
>;
