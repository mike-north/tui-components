...
// @public
export class ProgressComponent extends BaseTuiComponent<
  ProgressInput,
  ...
  readonly schema: zod.ZodObject<
    {
      ...
      style: zod.ZodDefault<
        zod.ZodEnum<["block", "shaded", "bracket", "arrow", "ascii"]>
      >;
...
export const progressInputSchema: z.ZodObject<
  {
    ...
    style: z.ZodDefault<
      z.ZodEnum<["block", "shaded", "bracket", "arrow", "ascii"]>
    >;
...
// @public
export const progressStyleSchema: z.ZodEnum<
  ["block", "shaded", "bracket", "arrow", "ascii"]
>;
